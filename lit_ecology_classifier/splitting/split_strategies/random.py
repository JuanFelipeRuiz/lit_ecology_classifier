...
Built in random split fdor splitting the data into train, validation and test sets.
...
class Random(BaseSplitStrategy):
    """
    Random split strategy for splitting the data into train, validation and test sets.
